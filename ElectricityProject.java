...
public class ElectricityProject extends JFrame implements ActionListener {
    ElectricityProject(){
        ...
        JMenuItem m2 = new JMenuItem("Cusomter Details");
